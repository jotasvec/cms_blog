...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h2 className='transition duration-700 text-center mb-8 cursor-pointer hover:text-pink-600 text-3xl font-serif' >
      ...
      <p className="text-justify text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8">{post.excerpt}</p>
